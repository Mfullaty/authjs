...
/**
 * This is an egnostic component, it works with server and
 * client components depending on where it is imported (parent)
 *
 */
    ...
    <Card className="w-[600px] shadow-sm">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
          ...
          <span className="truncate text-xs max-w[180px] font-mono p-1 bg-muted rounded-md">
